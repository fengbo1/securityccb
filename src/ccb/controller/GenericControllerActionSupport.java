 ...
 * 
 * @param keyWord2 关键字 2
 * 
 * @param keyWordtb 2关键字的字段2
 * 
 * @param keyWord3 关键字 3
 * 
 * @param keyWordtb3 关键字的字段 
 *  
 ...
 */
	...
	public String findAllDesc(String keyWordtb,String keyWord,String keyWordtb2,String keyWord2,String keyWordtb3,String keyWord3,String keyWordtb4,String keyWord4){
		totalRows=service.sizeAll(keyWordtb,keyWord,keyWordtb2,keyWord2,keyWordtb3,keyWord3,keyWordtb4,keyWord4);
		initPageProperties();
		list=service.findAllDesc("desc",currentPage, pageSize,keyWordtb,keyWord,keyWordtb2,keyWord2,keyWordtb3,keyWord3,keyWordtb4,keyWord4);
		return FIND_ALL_DESC_SUCCESS;
	}
	...
	public String findAllDesc(String timetb,String beginDate,String endDate,String keyWordtb,String keyWord,String keyWordtb2,String keyWord2,String keyWordtb3,String keyWord3,String keyWordtb4,String keyWord4){
		totalRows=service.sizeAll(timetb,beginDate,endDate,keyWordtb,keyWord,keyWordtb2,keyWord2,keyWordtb3,keyWord3,keyWordtb4,keyWord4);
		initPageProperties();
		list=service.findAllDesc("desc",currentPage, pageSize,timetb,beginDate,endDate,keyWordtb,keyWord,keyWordtb2,keyWord2,keyWordtb3,keyWord3,keyWordtb4,keyWord4);
		return FIND_ALL_DESC_SUCCESS;
	}
	//以上是新添加部分
	/*按日期字段排序*/
