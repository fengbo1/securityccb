...
public class ZhiBanFindArea {
	private static final Log log = LogFactory.getLog(ZhiBanFindArea.class);
	...
	private String url;
	private List<ZhiBanFindArea> pbalist;
	...
	*/
	...
	public List<ZhiBanFindArea> getPbalist() {
		return pbalist;
	}
	public void setPbalist(List<ZhiBanFindArea> pbalist) {
	...
	public String execute() throws Exception
	{
        ...
        pbalist=new ArrayList<ZhiBanFindArea>();	
		...
		if(chulist != null && chulist.size() >= 1){
			...
			for (int i=0;i<chulist.size();i++){
				...
				for (int j=0;j<arealist.size();j++){
					...
					ZhiBanFindArea pba = new ZhiBanFindArea();
