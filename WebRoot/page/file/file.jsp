...
function new_open(aaa,bbb)
{
	...
	aaa=encodeURI(aaa);
	bbb=encodeURI(bbb);
	 window.open("<%=path%>/page/file/downfile.jsp?url1="+aaa+"&title="+bbb,"","height=300,width=500,top=400,left=600"); 
}
</script>
...
$("tr.btbj:even").css({"background-color":"#bfd3fc","font-family": "黑体","font-size": "14px","font-weight":"lighter" }); 
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body >
								...
								<s:if test='type=="ya"'>应急管理->应急预案</s:if>
					<table height="80" align="center" cellpadding="0"
						...
						<td ><a class="button small blue" href="<%=path%>/page/file/fileadd.jsp?type=${type}&position=${position}">新增</a></td>
					    </c:if>
					    <td colspan="3" align="center">	<form action="<%=path%>/filesearch.action?position=<%=position %>>" method="post" name="fm1">
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">								
								...
								<td width="600px" height="25" align="center" valign="middle" nowrap>
									<div align="center">
									<a href="#" onclick="new_open('<s:property value="url1"/>','<s:property value="title"/>')"/><s:property value="title"/></a>									
									</div>
								</td>
								<td width="100px" height="25" align="center" valign="middle" nowrap>
