...
function tiaozhuan(jg,p)
{
	//parent.parent.location.reload();
	parent.parent.location.href="<%=path%>/anbaobutojigou.action?jigouid="+jg+"&position="+p;
	//parent.location.href="aasdasd";
	}
	...
	<form name="data" method="post">
		<table   height="161" align="center" cellpadding="0" cellspacing="2" style="margin-top: 30px; border: 0px;">
			<tr><td	style="color: #1778C2; padding-top: 15px; padding-bottom: 15px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="11" align="center" bordercolor="#FFFFFF"><b>总行直属机构</b>
			</td></tr>
			...
			<c:forEach items="${jigoulist}" var="jg" varStatus="status">
			<tr height="20" class="btbj" id="hang" style="height:20px">
				...
				<td  width="300"  height="30" align="center">
					<div align="center">
					<!-- <a href="<%=path%>/anbaobutojigou.action?jigouid=${jg.jigouid}&position=<%=position%>">${jg.jigou}</a> -->
					<a href="#" onclick="tiaozhuan('${jg.jigouid}','${position}')">${jg.jigou}</a>
					</div>
				</td>
				<td  width="300"  height="30" align="center">
					<div align="center">
					 <a href="<%=path%>/showjgxq.action?jigouid=${jg.jigouid}&type=chaxun">查看详情</a> 
