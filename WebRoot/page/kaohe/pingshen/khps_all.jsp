  ...
  <form action="commitall.action" method="post" >
					<table height="80" align="center" cellpadding="0" cellspacing="2" >
						...
						<tr>
							 <td
								...
								colspan="12" align="center" bordercolor="#FFFFFF"><b>待处理考核事项</b>
							</td>
						</tr>
					...
					<tr class="btbj" id="hang" style="height:25px">
								...
								<td width="100px" height="25" align="center" valign="middle" nowrap><div
										align="center">${wb.score}</div></td>
								<td width="100px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:idtoname(wb.preunder)}</div></td>		
								<td width="120px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:statustoname(wb.status,wb)}</div></td>
										
								
								
							<c:if test="${!ifanbaobz}">
								<td width="130px" height="25" align="center" valign="middle" nowrap><div align="center">
							<a href="<%=path%>/singlekhps.action?pnumber=${wb.pnumber}&newnumber=<%=newnumber%>&chaxunbz=0">处理</a></div></td>
							</c:if>	
							<c:if test="${ifanbaobz}">
								<td width="130px" height="25" align="center" valign="middle" nowrap><div align="center">
							 <a href="<%=path%>/scorefind.action?pnumber=${wb.pnumber}&xiugaibz=0&lasttime=0&thisunder=''&chaxunbz=1">详情</a><b></b></div></td>
							</c:if>
						</tr>
		...
		<c:if test="${role=='0'}"><button type="submit" value="Submit" style="width:120px">批量审批</button>
		<input type="hidden" name="newnumber" value="${newnumber}"/>
		</c:if></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
		</table>
		</form>
  </body>
</html>
