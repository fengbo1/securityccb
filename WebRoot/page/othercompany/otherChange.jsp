...
<body>
应急管理->外部单位应急联络->修改
<form name="fm1" action="<%=path%>/otherchangeok.action?" method="post" >
   ...
   <c:forEach items="${olist}" var="ad" varStatus="status">
	...
	<td width="300" bgcolor="#188BE8"><input name="company" type="text" id="company" value="${ad.company }">
	...
	<td width="300" bgcolor="#188BE8"><input name="department" type="text" id="department" value="${ad.department }"></td>	
	</tr>	

	<tr class="aa">
	<td width="300" height="40" bgcolor="#188BE8">相关人员职务：</td>
	<td width="300" bgcolor="#188BE8"><input name="job" type="text" id="job" value="${ad.job }"></td>	
	</tr>
	
	<tr class="aa">
	<td width="300" height="40" bgcolor="#188BE8">相关人员姓名：</td>
	<td width="300" bgcolor="#188BE8"><input name="name" type="text" id="name" value="${ad.name }"></td>	
	</tr>

	<tr class="aa">
	<td width="300" height="40" bgcolor="#188BE8">相关人员固定电话：</td>
	<td width="300" bgcolor="#188BE8"><input name="tel" type="text" id="tel" value="${ad.tel }" ></td>	
	</tr>
	
	<tr class="aa">
	<td width="300" height="40" bgcolor="#188BE8">相关人员手机：</td>
	<td width="300" bgcolor="#188BE8"><input name="phone" type="text" id="phone"  value="${ad.phone }"></td>	
	</tr>
	
	<tr class="aa">
	<td width="300" height="40" bgcolor="#188BE8">备注：</td>
	<td width="300" bgcolor="#188BE8"><input name="remark" type="text" id="remark"  value="${ad.remark }" ></td>	
	</tr>
